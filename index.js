...
function compareCharCodeAtAndCodePointAt(string, index) {
  ...
  let codePointAtResult = console.log(string.codePointAt(index));
...
function padString(original, length, padWith, side) {
  ...
  // Якщо "start", використовуємо padStart console.log(c.padStart(15, "start"));
